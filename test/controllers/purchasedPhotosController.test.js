...
const {
  getPurchasedPhotos,
} = require('../../src/controllers/purchasedPhotosController'); // 'purchasedPhotosController'에서 'getPurchasedPhotos' 함수를 가져옵니다.
...
getPurchasedPhotos.getNFTCollectionFromBlockchain =
