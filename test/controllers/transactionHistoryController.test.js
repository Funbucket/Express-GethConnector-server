...
} = require('../../src/controllers/transactionHistoryController'); // 'transactionHistoryController'에서 'getTransactionHistory' 함수를 가져옵니다.
...
getTransactionHistory.__setMockGetNFTCollectionFromBlockchain(
...
describe('POST /getTransactionHistory', () => {
  it('should get transaction history', async () => {
    ...
    expect(response.body).toEqual([['tx1', 'tx2'], ['tx3']]);
  });
